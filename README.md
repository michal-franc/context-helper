...
```
[Opus 4.5] my-project | In:23.3k Out:0.9k (10%) | I:127 D:2.1 A:82%
```

- `[Opus 4.5]` - Current model
- `my-project` - Current working directory (folder name)
- `In:23.3k` - Input tokens (context sent to the model: system prompt, conversation history, tool results)
- `Out:0.9k` - Output tokens (tokens generated by the model in this session)
- `(10%)` - Context window usage percentage
- `I:127` - Instruction count (127 directives detected)
- `D:2.1` - Instruction density (directives per 1000 chars)
- `A:82%` - Estimated accuracy (82%)
